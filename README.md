...
`npm run test:e2e` This will run the application and the Cypress tests in two terminals. After tests are run, it will stop all Razzle processes (we use Razzle for our application).
